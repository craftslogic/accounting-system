  ...
  return (
    <div className="w-full max-w-md animate-slide-up">
      ...
      <div className="glass rounded-2xl p-8 shadow-2xl">
        {errorParam && (
          <div className="flex items-center gap-2 text-sm text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg px-4 py-3 mb-6">
        ...
        <Button
          type="button"
          variant="outline"
          className="w-full font-semibold h-11 bg-background hover:bg-muted cursor-pointer mb-6"
        ...
        <div className="mb-6 flex items-center">
          ...
          <span className="px-4 text-sm text-muted-foreground">Or sign in with email</span>
          <div className="flex-1 border-t border-muted"></div>
        </div>
