...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-4 left-[50%] z-[100] flex max-h-screen -translate-x-[50%] flex-col-reverse p-0 w-[calc(100%-2rem)] max-w-md gap-2 sm:bottom-4 sm:right-4 sm:left-auto sm:translate-x-0 sm:flex-col sm:max-w-[420px]",
      className
    )}
    {...props}
  />
